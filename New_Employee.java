...
//        p1.setAlignmentX(Component.CENTER_ALIGNMENT);
      ...
      //Layout for panel
        p1.setLayout(new GridLayout(8,3,5,40));
        l1 = new JLabel("Name");
...
//        p1.setComponentOrientation(ComponentOrientation.LEFT_TO_RIGHT);
        ...
        p1.setBorder(new EmptyBorder(10, 10, 10, 50));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String e = t6.getText();
        String p = t7.getText();
        //Query for insertion of data in employee table
        ...
        try{
            ...
            this.setVisible(false);//To close new employee frame
        }
        catch(Exception ee){
            ee.printStackTrace();
        }
